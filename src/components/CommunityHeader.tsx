...
export function CommunityHeader({ community }: CommunityHeaderProps) {
  ...
  const themeClass =
    themeColors[community.theme as keyof typeof themeColors] ||
    themeColors.DEFAULT;
  const categoryEmoji =
    categoryEmojis[community.category as keyof typeof categoryEmojis] || "🔗";

  return (
    <div className="rounded-xl bg-card border overflow-hidden">
      {/* Banner */}
      <div className={cn("relative h-32 md:h-48 bg-gradient-to-r", themeClass)}>
        {community.banner ? (
          <Image
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {(community.isCreator ||
                  ...
                  <Button mode="secondary">Manage</Button>
                )}
              </div>
            </div>
          </div>
